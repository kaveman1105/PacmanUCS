...
public class PacmanUCS implements PacAction {
	...
	public PacFace action(Object state) {
		...
		if (path == null) {
			...
			n.food.add(new Location(1,2));
				System.out.println("food size = " + n.food.size());
			n.food.add(new Location(2,2));
			System.out.println("food size = " + n.food.size());
			n.food.add(new Location(1,2));
			System.out.println("food size = " + n.food.size());
...
//	}
	...
	class node {
		...
		public node(int x, int y, int steps) {
			...
			this.old = new TreeSet<Location>();
			this.current = new TreeSet<Location>();
			this.history = "";
		}
